...
func GeneratePDF(r *PDFReport) (string, error) {
	...
	pdf.SetHeaderFuncMode(func() {
		...
		pdf.SetTextColor(45, 109, 164)
		pdf.CellFormat(contentW/2, 5, "TESSERA AGENT", "", 0, "L", false, 0, "")
		pdf.SetFont("Helvetica", "", 8)
		pdf.SetTextColor(100, 100, 100)
		pdf.CellFormat(contentW/2, 5, r.GeneratedAt.Format("2006-01-02 15:04 UTC"), "", 1, "R", false, 0, "")
		pdf.SetDrawColor(45, 109, 164)
		pdf.SetLineWidth(0.4)
		pdf.Line(marginL, 11, pageW-marginR, 11)
		...
		pdf.CellFormat(170, 24, "Tessera Agent", "", 0, "C", false, 0, "")
		pdf.TransformEnd()
	...
	pdf.SetFooterFunc(func() {
		...
		pdf.SetTextColor(100, 100, 100)
		pdf.CellFormat(contentW*0.6, 4, "Generated by Tessera Agent | The Synthesis Hackathon", "", 0, "L", false, 0, "")
