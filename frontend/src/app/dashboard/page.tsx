...
import {
  ...
  getTrustGraph,
  getSimulation,
  // detectBridge,         // Coming Soon — bridge feature disabled
  // connectBridgeToServer, // Coming Soon — bridge feature disabled
  // disconnectBridge,      // Coming Soon — bridge feature disabled
  type StatusResponse,
  ...
  // type BridgeStatus,     // Coming Soon — bridge feature disabled
} from "@/lib/api";
...
export default function DashboardPage() {
  ...
  /* ─── Local Claude Bridge — DISABLED / Coming Soon ─── */
  // Bridge state and handlers removed. Feature is in development.
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 pt-4 sm:pt-8 pb-20">
        ...
        {providersData && (() => {
          ...
          const provMeta: Record<string, { label: string; icon: string }> = {
            "claude-local": { label: "Claude CLI via Bridge (Coming Soon)", icon: "BR" },
          ...
          return (
            <div className="mb-6 bg-white/70 backdrop-blur-2xl rounded-2xl border border-slate-200/60 shadow-sm p-3 sm:p-4 relative z-30">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 text-xs font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-2.5 py-2 rounded-lg">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Local Claude Bridge — Coming Soon
                  </span>
                </div>
              </div>
            </div>
        ...
        {/* Bridge Connection Modal — DISABLED / Coming Soon
           Original modal code preserved here for future re-enablement. */}
